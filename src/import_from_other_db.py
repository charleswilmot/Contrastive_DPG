if __name__ == '__main__':
    ...
    parser.add_argument('--db-name1', default='Contrastive_DPG_v2', help='name for MySQL DB')
    ...
    parser.add_argument('--db-name2', default='Contrastive_DPG_v2', help='name for MySQL DB')
